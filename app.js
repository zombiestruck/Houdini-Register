...
app.set('views', path.join(__dirname, './web_pages'))
app.use('/css', express.static(path.join(__dirname, './web_pages/css')))
app.use('/js', express.static(path.join(__dirname, './web_pages/js')))
app.use('/colors', express.static(path.join(__dirname, './web_pages/colors')))
app.use('/img', express.static(path.join(__dirname, './web_pages/img')))
